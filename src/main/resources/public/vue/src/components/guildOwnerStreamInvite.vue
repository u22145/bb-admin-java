<template>
    <div>
       <div class="Breadcrumbs"><span>公会管理系统</span><span>报表管理</span><span>直播间报表</span><span>详情</span></div>
           ...
           <el-form class="demo-form-inline" :inline="true" :label-position="labelPosition" >
                ...
                <div class="information whiteBg">
                    <el-table :summary-method="getSummaries" show-summary  stripe :data="liveData" style="width: 100%">
                        <el-table-column width="150" prop="startedAt" label="开始时间" ></el-table-column>
                        <el-table-column width="150" prop="closedAt" label="结束时间"></el-table-column>
                        ...
                        <el-table-column width="135" prop="ticketBuyers" label="门票收益/人">
                            <template slot-scope="scope">
                                <el-button @click="ticketBuyers = true" type="text">{{scope.row.ticketBuyers}}</el-button>
                            </template>
                        </el-table-column>
                        <el-table-column width="135" prop="giftBuyers" label="礼物打赏/人">
                            <template slot-scope="scope">
                                <el-button @click="giftBuyers = true" type="text">{{scope.row.giftBuyers}}</el-button>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column width="135" prop="total" label="＊进入直播间人数"></el-table-column>
                        <el-table-column width="135" prop="viewers" label="＊公屏条数/人"></el-table-column>
                ...
                <el-dialog title="礼物打赏详情" :visible.sync="giftBuyers">
                    <el-table stripe :data="liveData" style="width: 100%">
                ...
                <el-dialog title="彩票盈利详情" :visible.sync="lottoExp" >
                    <el-table stripe :data="liveData" style="width: 100%">
                        <el-table-column width="130" prop="startedAt" label="*投注时间" ></el-table-column>
                        <el-table-column width="130" prop="uid" label="*用户ID"></el-table-column>
                        <el-table-column width="130" prop="nickname" label="*彩票名称"></el-table-column>
                        <el-table-column width="130" prop="nickname" label="*玩法群"></el-table-column>
                        <el-table-column width="130" prop="nickname" label="*玩法组"></el-table-column>
                        <el-table-column width="130" prop="nickname" label="*投注内容"></el-table-column>
                        <el-table-column width="130" prop="nickname" label="*投注金额"></el-table-column>
                        <el-table-column width="130" prop="nickname" label="*状态"></el-table-column>
                        <el-table-column width="130" prop="nickname" label="*中奖金额"></el-table-column>
                        <el-table-column width="130" prop="nickname" label="*盈利"></el-table-column>
                    </el-table>
                    <el-pagination
                    @current-change="handleCurrentChange"
                    :page-size="100"
...
export default {
    data() {
        return {
            ...
            fakeData: [
            {
                ...
                "viewers": 121,
                "peakViewers": 99,
                "startedAt": "2020-08-20 08:00:22",
                "closedAt": "2020-08-20 08:00:22"
            }],
            ticketBuyers: false,
            giftBuyers:false,
            lottoExp:false,
    ...
    methods: {
        getGuildContribution() {
            ...
            this.$axios.get('gm/rpt/live/detail', {
                params: {
                    from : this.from,
                    to: this.to,
                    page: this.page,
        ...
        backTo(data) {
            this.$router.push('/guildOwnerStreamReport')
        },
        getSummaries(param) {
