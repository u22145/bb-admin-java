<template>
    <div>
       <div class="Breadcrumbs"><span>公会管理</span><span>公会数据报表</span><span>总数据详情</span><span>1V1视频详情</span><span>详情</span></div>
           ...
           <el-form class="demo-form-inline" :inline="true" :label-position="labelPosition" >
                ...
                <div class="information whiteBg">
                    <el-table show-summary :summary-method="getSummaries" stripe :data="liveData" style="width: 100%">
                        <el-table-column width="150" prop="fromDT" label="开始时间"></el-table-column>
                        <el-table-column width="150" prop="toDT" label="结束时间"></el-table-column>
                        ...
                        <el-table-column width="130" prop="streamExp" label="单价/分"></el-table-column>
                        <el-table-column width="130" prop="streamExp" label="时长计费" ></el-table-column>
                        <el-table-column width="135" prop="giftExp" label="礼物打赏">
                        ...
                        <!-- <el-table-column width="130" prop="total" label="公屏条数"></el-table-column> -->
                        <!-- 看來是錯的 -->
                        <!-- <el-table-column prop="total" label="用户ID"></el-table-column> -->
                    </el-table>
                     <el-row>
...
export default {
    data() {
        return {
            ...
            fakeData: [
            {
                ...
                "giftExp": 3,
                "total": 50.0000,
                "fromDT": "2020-08-19 15:10:30",
                "toDT": "2020-08-19 15:10:30"
            },
            {
                "uid": 1001,
                "nickname": "adminqfqef",
    ...
    methods: {
        getGuildContribution() {
            ...
            this.$axios.get('guild/rpt/ps/detail', {
                params: {
                    uid:this.id,
                    from : this.from,
                    to: this.to,
